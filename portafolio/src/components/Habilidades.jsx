import { lenguajes, listaLenguajes, listaSkills, skills } from "../utils/informacionHabilidades";
    ...
    return (
        <>
            <div className="flex flex-col text-center">
                <h2 className="text-[#4F6CF4] font-[700] text-[1.2rem] mb-[1rem]">Lenguajes/Frameworks</h2>
                <div className="grid grid-cols-3 justify-between">
                    {listaLenguajes.map((lenguaje, index) => (
